...
const App = () => {
    ...
    const fetchFields = async () => {
        try {
            const response = await axios.get('https://wiki-scraping-obg6-9ii4io71o-nikhil18patils-projects.vercel.app/api/filters/');
    ...
    const fetchValues = async (field) => {
        try {
            ...
            const response = await axios.get(`https://wiki-scraping-obg6-9ii4io71o-nikhil18patils-projects.vercel.app/api/filters/?field=${field}`);
    ...
    const handleScraping = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post('https://wiki-scraping-obg6-9ii4io71o-nikhil18patils-projects.vercel.app/api/scrape/', { urls: urls.split('\n') });
    ...
    const handleApplyFilters = async () => {
        ...
        try {
          ...
          const response = await axios.get('https://wiki-scraping-obg6-9ii4io71o-nikhil18patils-projects.vercel.app/api/filtered-results/', { params });
